...
<html>
	...
	<body>
		<div style="text-align: center; margin-top: 200px">
		  ...
		  <g:form method="post">
				<g:textField style="margin-left: 110px; width: 500px; font-size: 15px" id="query" name="query" value=""/>	
				<g:select style="font-size: 15px" name="collectionId" from="${collections}" optionKey="id"/><br/>
